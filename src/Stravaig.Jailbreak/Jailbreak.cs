...
namespace Stravaig.Jailbreak
{
    public abstract class Jailbreak : DynamicObject
    {
        ...
        protected virtual BindingFlags AllAccessModifiers => BindingFlags.Public | BindingFlags.NonPublic;
        ...
        {
            MemberInfo[] members = _targetType.GetMember(binder.Name, IsPropertyOrField,
        ...
        {
            var members = _targetType.GetMembers(AllAccessModifiers | BindingFlags.Instance | BindingFlags.GetField |
